 ...
 * @author Admin
 */
public class KhachHangGUI extends javax.swing.JDialog {
    DefaultTableModel model=new DefaultTableModel();
    KhachHangBUS bus=new KhachHangBUS();
    /**
     * Creates new form KhachHangGUI
     */
    public KhachHangGUI(java.awt.Frame parent, boolean modal) {
       super(parent, modal);
        try {
    ...
    private void initComponents() {
            ...
            .addGroup(p3Layout.createSequentialGroup()
                ...
                .addGroup(p3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(p3Layout.createSequentialGroup()
                        .addComponent(lbInfo)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txInfo, javax.swing.GroupLayout.PREFERRED_SIZE, 286, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        tbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã khách hàng", "Họ khách hàng", "Tên khách hàng", "Giới tính", "Ngày sinh", "Số điện thoại", "Địa chỉ"
            }
        ));
    ...
    private void tblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblMouseClicked
        ...
        int i= tbl.getSelectedRow();
        if(i>=0){
        txMaKH.setText(tbl.getModel().getValueAt(i, 0).toString());
       ...
       if(tbl.getModel().getValueAt(i,4).equals("Nữ")){
        ...
        txDiaChi.setText(tbl.getModel().getValueAt(i, 5).toString());
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
      ...
      kh.setSdt(txSdt.getText());
        ...
        for(int i=0;i<bus.dskh.size();i++){
            if(bus.dskh.get(i).getMa().toLowerCase().trim().equals(txMaKH.getText().toLowerCase().trim())){
                check1=false;
        ...
        int res=JOptionPane.showConfirmDialog(rootPane, "Bạn muốn thêm khách hàng này?");
        if(res==JOptionPane.YES_OPTION){
            if(bus.addkh(kh)){
                showResult();
                reset();
    ...
    public void showResult(){
         KhachHangDTO kh= bus.dskh.get(bus.dskh.size()-1);
         model.addRow(new Object[] {
            kh.getMa(),kh.getHo(),kh.getTen(),kh.getNgaysinh(),kh.getGender(),kh.getDiachi(),kh.getSdt()
            });
    }
